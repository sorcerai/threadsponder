        ...
        <div className="space-y-8">
            ...
            <div className="flex items-end justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button variant="outline" size="sm" onClick={handleForceCheck} className="bg-zinc-900 border-zinc-800 hover:bg-zinc-800 text-xs gap-2">
                        ...
                        {recentActivity.length > 0 ? (
                            <div className="space-y-3 flex-1 overflow-y-auto">
                                {recentActivity.map((reply) => (
                                    <div key={reply.id} className="flex gap-3 p-3 rounded-lg bg-zinc-900/50 border border-zinc-800/50">
                        ...
                        <SpotlightCard className="p-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <button
                                    ...
                                    className={`w-full p-3 rounded-lg border text-left transition-all ${
                                        replyModeData?.replyMode === 'hostile_only'
                                ...
                                <button
                                    ...
                                    className={`w-full p-3 rounded-lg border text-left transition-all ${
                                        replyModeData?.replyMode === 'friendly_only'
                                ...
                                <button
                                    ...
                                    className={`w-full p-3 rounded-lg border text-left transition-all ${
                                        replyModeData?.replyMode === 'match_energy'
